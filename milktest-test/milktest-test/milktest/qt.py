...
class Ui_MainWindow(object):
    ...
    def cao2(self):
        ...
        regr_1 = joblib.load('train_model.m')  # 加载模型  蛋白质protain
        regr_2 = joblib.load('train_model2.m')  # 加载模型  脂肪fat
        ...
        print('%.5f' % pred_test1)
        print('%.5f' % pred_test2)
        self.lineEdit_8.setText(str('%.5f' % pred_test1))
        self.lineEdit_7.setText(str('%.5f' % pred_test2))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "Protain"))
